...
pub fn run_application(id: String) -> Result<bool, String> {
    {
        ...
        let mut system = system::System::new(true, id.clone(), all_files);
        logger::log(format!("Application {} environment initialized. Starting...", id), logger::LogType::INFO);
        system.start();
    }
    logger::log(String::from("Application Launcher environment destroyed. Finished! Threads may be runned"), logger::LogType::INFO);
    Ok(true)
}
